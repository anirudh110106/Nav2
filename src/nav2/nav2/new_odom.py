...
class MotorOdom(Node):
    def __init__(self):
        ...
        # CORRECTED: 90 degrees maps ROS +X (forward) to robot kinematics +Y (forward)
        self.heading_offset_deg = 117.0 
    ...
    def update(self):
        # CORRECTED: Safe reading to prevent NoneType errors on dropped serial packets
        try:
...
def main():
    ...
    try: 
        ...
        # Added a clean shutdown to prevent hanging ports
        node.destroy_node()
        rclpy.shutdown()
